package com.google.strategic.demo.models.cloudsql;
...
public class Connector
{
    ...
    public static String readDatabase(String args) throws IOException, SQLException {
        ...
        String instanceConnectionName = "project-id:region(eg: us-central1):cloudsqlinstancename";
        // TODO: fill this in
        // The database from which to list tables.
        String databaseName = "cloudsqldbname";
        ...
        try (Statement statement = connection.createStatement()) {
            ...
            String que="select ingredients from contents2 where product like '%RASPBERRY 52ML%'";
